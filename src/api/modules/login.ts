...
export const loginApi = (params: Login.ReqLoginForm) => {
  return http.post<Login.ResLogin>(`/admin/user/login_redirect`, params, { noLoading: false }); // 正常 post json 请求  ==>  application/json
...
export const logoutApi = () => {
  return http.post(`/admin/user/login_out`);
};
