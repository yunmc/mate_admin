<template>
  <div class="setViersion">
    <el-dialog v-model="drawerVisible" :title="drawerProps.title" width="35%" @before-close="handleClose">
      <el-form
        ref="ruleFormRef"
        label-width="100px"
        label-suffix=" :"
      ...
      >
        <el-form-item label="类型" prop="client_type">
          <el-select
            style="width: 100%"
            v-model="drawerProps.row!.client_type"
        ...
        <el-form-item label="审核版本" prop="version">
          <el-input v-model="drawerProps.row!.version" placeholder="请输入版本号" clearable></el-input>
        </el-form-item>
      </el-form>
      <template #footer>
